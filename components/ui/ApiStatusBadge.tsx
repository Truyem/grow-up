...
interface ApiStatusBadgeProps {
    status: ApiStatus;
    onKeyChange?: () => void; // Callback to refresh status after manual change
}
                            ...
                            <button
                                ...
                                className={`
                                    ...
                                    ${isActive && !isRateLimited
                                        ...
                                        : isRateLimited
                                            ? 'bg-red-500/30 text-red-300 border border-red-500/30 hover:bg-red-500/40 hover:scale-105'
                                            : 'bg-white/5 text-gray-500 border border-white/10 hover:bg-white/10 hover:border-cyan-500/30 hover:text-cyan-300 hover:scale-105'
                                    }
