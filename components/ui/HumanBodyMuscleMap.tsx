...
const HumanBodyMuscleMap = ({
  ...
  const muscleToSvgElem = {
    ...
    [MuscleGroup.TricepsLong]: 'Triceps',
    [MuscleGroup.TricepsLateral]: 'Triceps',
    [MuscleGroup.Forearms]: 'Forearms',
    [MuscleGroup.Quads]: 'Quads',
    [MuscleGroup.Hamstrings]: 'Hamstrings',
    [MuscleGroup.Glutes]: 'Glutes',
    [MuscleGroup.Calves]: 'Calves',
    [MuscleGroup.UpperAbs]: 'Abdominals',
    [MuscleGroup.LowerAbs]: 'Abdominals',
    [MuscleGroup.Obliques]: 'Obliques',
  }

  const svgElemToMuscle = {
    Chest: MuscleGroup.Chest,
    Shoulders: MuscleGroup.FrontDelts,
    Traps: MuscleGroup.Traps,
    Lats: MuscleGroup.Lats,
    'Lower back': MuscleGroup.LowerBack,
    Biceps: MuscleGroup.Biceps,
    Triceps: MuscleGroup.TricepsLong,
  ...
  const mappedMuscles = Array.from(
    new Set(
      selectedMuscles
        .filter((muscle) => muscle !== MuscleGroup.None)
        .map((muscle) => muscleToSvgElem[muscle])
        .filter(Boolean)
    )
  )
  useEffect(() => {
